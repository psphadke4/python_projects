...
class create_user(UserCreationForm):
    first_name = forms.CharField(max_length=120 ,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'first name'}))
    last_name =  forms.CharField(max_length=120,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'last name'}))
    email = forms.CharField(max_length=120,label="",widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Email ID'}))
    ...
    class Meta:
        ...
        def __init__(self,*args,**kwargs):
            super(create_user,self).__init__(*args,**kwargs)
